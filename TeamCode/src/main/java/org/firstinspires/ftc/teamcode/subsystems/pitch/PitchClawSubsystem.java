...
public class PitchClawSubsystem implements Subsystem {
    ...
    public DepositClaw_state CURRENT_STATE = DepositClaw_state.UNINITIALISED;

    public PitchClawSubsystem(HardwareMap hardwareMap) {
        clawServo = hardwareMap.get(Servo.class, "dclsrv");

        CURRENT_STATE = DepositClaw_state.INITIALISED;
    }
